...
const SearchBar = ({searchCourses, searchPerformed}) => {
  ...
  return (
    <div className={`py-8 w-80vw md:w-8/12 absolute ${searchPerformed ? 'top-0' : 'top-2/4 -translate-y-2/4'} left-2/4 transform z-5 -translate-x-2/4 ${animate ? 'animate-push-search-bar' : ''}`}>
